...
\bstctlcite{IEEEexample:BSTcontrol}
    \title{A Belief Propagation Algorithm for Multipath-Based UAV Waypoint Opportunistic Navigation in Urban Canyon}
...
}{Roberg \MakeLowercase{\textit{et al.}}: A Belief Propagation Algorithm for Multipath-Based UAV Waypoint Opportunistic Navigation in Urban Canyon}
